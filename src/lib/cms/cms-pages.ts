...
> = {
  ...
  contact: {
    label: "Contact",
    description: "Page intro and labels. Email, phone, and per-country addresses are edited in Admin → Contact.",
    path: "/pages/contact",
  },
  privacy: {
...
export const CMS_PAGE_FIELDS: Record<CmsPageSlug, CmsFieldDef[]> = {
  ...
  contact: [
    ...
    { key: "email", label: "Email address", skip: true },
    { key: "phoneLabel", label: "Phone label" },
    { key: "phone", label: "Phone number", skip: true },
    { key: "addressLabel", label: "Address label" },
    { key: "address", label: "Address", skip: true, multiline: true },
    { key: "hoursLabel", label: "Hours label" },
    { key: "hours", label: "Business hours", skip: true, multiline: true },
